...
Fred is a chat bot built on the [Hubot][hubot] framework. It was
...
Then you can interact with Fred by typing `Fred help`.

    Fred> Fred help
    Fred animate me <query> - The same thing as `image me`, except adds [snip]
    Fred help - Displays all of the help commands that Fred knows about.
    ...
...
Fred is set up to handle TypeScript and CoffeeScript. The compiler is set to be easy enough
